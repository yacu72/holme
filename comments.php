...
<section id="respond">
	...
	<form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<textarea class="commentform__textarea" placeholder="Write your comment here..." name="comment" id="comment" rows="8" tabindex="4"></textarea>
	</p>
	<!--<p id="allowed_tags" class="small"><strong>XHTML:</strong>
		...
		<?php else : ?>
			<div class="commentform__metadata">
				<p class="column1">
					<!--<label for="author">
						<?php
					...
					<input placeholder="<?php echo 'Name'; ?>" type="text" class="five" name="author" id="author" value="<?php echo esc_attr( $comment_author ); ?>" size="22" tabindex="1" <?php if ( $req ) { echo "aria-required='true'"; } ?>>
				</p>
				<p class="column1">
					<!--<label for="email">
						<?php
					...
					<input placeholder="Email" type="text" class="five" name="email" id="email" value="<?php echo esc_attr( $comment_author_email ); ?>" size="22" tabindex="2" <?php if ( $req ) { echo "aria-required='true'"; } ?>>
				</p>
				<p class="column1">
					<!--<label for="url">
						<?php
					...
					<input placeholder="Website" type="text" class="five" name="url" id="url" value="<?php echo esc_attr( $comment_author_url ); ?>" size="22" tabindex="3">
				</p>
			</div>
		<?php endif; ?>
		<p>

		<p><input name="submit" class="button button-form-submit" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e( 'Submit Comment', 'foundationpress' ); ?>"></p>
